...
/// <summary>
///     Loads a <see cref="JsonTestCase" /> from a JSON descriptor file.
/// </summary>
public class JsonTestCase : ITestCase
{
    ...
    /// <summary>
    ///     Deserializes a <see cref="JsonTestCase" /> from the JSON descriptor at <paramref name="testFilePath" />.
    /// </summary>
    /// <param name="testFilePath">The path to the JSON descriptor file.</param>
    /// <returns>
    ///     The deserialized test case, with <see cref="ITestCase.Directory" /> set to the descriptor's directory.
    /// </returns>
    /// <exception cref="FileNotFoundException">Thrown when <paramref name="testFilePath" /> does not exist.</exception>
    /// <exception cref="IOException">Thrown when the descriptor cannot be parsed into a <see cref="JsonTestCase" />.</exception>
    ...
    /// <summary>
    ///     Asynchronously deserializes a <see cref="JsonTestCase" /> from the JSON descriptor at
