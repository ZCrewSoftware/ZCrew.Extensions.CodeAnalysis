...
internal static class EmbeddedAttributeInfoFactory
{
    ...
    private static bool IsAttribute(INamedTypeSymbol typeSymbol)
    {
        ...
        {
            // TODO: any way to use IsType generator?
            var isAttribute =
                baseType is
                {
                    Name: "Attribute",
    ...
    {
        return typeSymbol
            is { Name: "Type", ContainingNamespace: { Name: "System", ContainingNamespace.IsGlobalNamespace: true } };
    }
